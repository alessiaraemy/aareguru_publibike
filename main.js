...
const positionData = [
    ...
    { id: 898, position: { top: "17%", left: "65%" }, infoBoxPosition: { top: "-40%", left: "-300%" }}, //Altenbergstrasse
    { id: 254, position: { top: "30%", left: "65%" }, infoBoxPosition: { top: "-40%", left: "-300%" }}, //Nydegg
    ...
    { id: 312, position: { top: "50%", left: "70%" }, infoBoxPosition: { top: "-40%", left: "-280%" }}, //Ka-We-De
    { id: 323, position: { top: "52%", left: "80%" }, infoBoxPosition: { top: "-40%", left: "-300%" }}, //Restaurant Dählhölzli
    { id: 423, position: { top: "65%", left: "75%" }, infoBoxPosition: { top: "-40%", left: "-300%" }}, //Camping Eichholz
    { id: 326, position: { top: "30%", left: "90%" }, infoBoxPosition: { top: "-40%", left: "-270%" }} //Bärenpark
];
